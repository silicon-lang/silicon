...
#ifndef SILICON_CGLOOP_H
#define SILICON_CGLOOP_H
...
namespace silicon::codegen {
    ...
    class CGLoop : public CGNode, public parser::AST::Loop {
    protected:
        llvm::Value *body_codegen(Context *ctx);

    public:
        explicit CGLoop(parser::AST::Loop *node);
